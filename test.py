...
parser.add_argument('--pth_path', type=str, default='./checkpoints/MINet/SOTA.pth')

for _data_name in ['CAMO','CHAMELEON','COD10K','NC4K']:
    data_path = './data/TestDataset/{}/'.format(_data_name)
    save_path = './results/MINet/{}/'.format(_data_name)
    ...
    for i in range(test_loader.size):
        ...
        res, out1, out2, out3, out4, z1, z2, wavelet = model(image)
